...
6. **Security & code analysis scaffolding**: I use a skill that includes a set of skills that knows how I want linting, security reviews, etc. Didn't publish that one yet.
