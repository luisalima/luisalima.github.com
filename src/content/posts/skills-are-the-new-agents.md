...
and let it run. You can even use [Claude Agents SDK]() to 

Skills enable agent capabilities. However, I would also argue that
skills _are_ the new agents, and that all that we need in order
to develop an "agent"
...
shortcuts for capabilities that agents need. And, increasingly,
...
software development worfkows to agents. 
