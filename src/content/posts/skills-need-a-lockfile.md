...
# Skills are "just" text files. But where's the lockfile?

I already wrote about [how skills are the new agents]().
But the distribution of skills is a mess right now.
...
TODO insert image from https://xkcd.com/927/ here
...
and most of folks outside of Data Science don't us Conda. 

So I kept tugging at the thread: if skills are just packages, what's the *smallest* 
...
This is quick, but it leaves four holes that every package ecosystem closed years ago:
...
it is a huge supply-chain problem.

## What the landscape provides already
...
trap. It's this workflow — manifest in `package.json`, a lockfile, `--frozen` in CI 
— getting absorbed into the tool that already has the ecosystem. 
...
it there. And if you want to try it: `npx skills-lock`.
